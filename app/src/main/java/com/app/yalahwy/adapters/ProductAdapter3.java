...
import com.app.yalahwy.databinding.ProductRow4Binding;
...
public class ProductAdapter3 extends RecyclerView.Adapter<ProductAdapter3.MyHolder> {
    ...
    public ProductAdapter3(List<ProductModel> list, Context context, Fragment_Home fragment_home, String type, String lang) {
        this.list = list;
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ProductRow4Binding bankRowBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.product_row4, parent, false);
    ...
    public static class MyHolder extends RecyclerView.ViewHolder {
        private ProductRow4Binding binding;

        public MyHolder(ProductRow4Binding binding) {
