package com.app.yalahwy.ui.activity_product_details;
...
import com.app.yalahwy.adapters.ProductSliderAdapter;
import com.app.yalahwy.adapters.ViewPagerAdapter;
import com.app.yalahwy.databinding.ActivityProductDetailsBinding;
...
import com.app.yalahwy.mvp.activity_product_details_mvp.ActivityProductDetailsPresenter;
import com.app.yalahwy.mvp.activity_product_details_mvp.ActivityProductDetailsView;
import com.app.yalahwy.tags.Tags;
import com.app.yalahwy.ui.activity_cart.CartActivity;
import com.app.yalahwy.ui.activity_product_details.fragments.Fragment_Comments;
import com.app.yalahwy.ui.activity_product_details.fragments.Fragment_Details;
import com.app.yalahwy.ui.activity_product_details.fragments.Fragment_Policy;
...
public class ProductDetailsActivity extends AppCompatActivity implements ActivityProductDetailsView {
    ...
    private void initView() {
        ...
        presenter.getProductById(String.valueOf(product_id));
...
//            }
        ...
        binding.btnShare.setOnClickListener(v -> {
            String shareLink = Tags.base_url+"api/shareLink/"+productModel.getId();
    ...
    public void onSuccess(ProductModel data) {
        ...
        if (productModel.getImages().size() > 0) {
            List<GalleryModel> galleryModelList = new ArrayList<>(productModel.getImages());
