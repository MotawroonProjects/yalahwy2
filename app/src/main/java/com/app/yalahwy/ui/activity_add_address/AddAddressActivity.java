package com.app.yalahwy.ui.activity_add_address;
...
import com.app.yalahwy.databinding.ActivityAddAddressBinding;
import com.app.yalahwy.language.Language;
import com.app.yalahwy.models.AddAddressModel;
import com.app.yalahwy.models.AddressModel;
import com.app.yalahwy.models.SelectedLocation;
import com.app.yalahwy.models.UserModel;
import com.app.yalahwy.mvp.activity_add_address_mvp.ActivityAddAddressPresenter;
import com.app.yalahwy.mvp.activity_add_address_mvp.ActivityAddAddressView;
...
public class AddAddressActivity extends AppCompatActivity implements ActivityAddAddressView {
    ...
    private void initView() {
        ...
        addAddressModel.setPhone(userModel.getData().getUser().getPhone());
        addAddressModel.setUser_id(String.valueOf(userModel.getData().getUser().getId()));
