        ...
        Api.getService(Tags.base_url)
                ...
                .enqueue(new Callback<ProductDataModel>() {
                    ...
                    public void onResponse(Call<ProductDataModel> call, Response<ProductDataModel> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body() != null  && response.body().getData() != null) {
                                view.onFeaturedProductSuccess(response.body().getData().getData());
        ...
        Api.getService(Tags.base_url)
                ...
                .enqueue(new Callback<ProductDataModel>() {
                    ...
                    public void onResponse(Call<ProductDataModel> call, Response<ProductDataModel> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body() != null  && response.body().getData() != null) {
                                view.onMostSellerSuccess(response.body().getData().getData());
        ...
        Api.getService(Tags.base_url)
                ...
                .enqueue(new Callback<ProductDataModel>() {
                    ...
                    public void onResponse(Call<ProductDataModel> call, Response<ProductDataModel> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body() != null &&  response.body().getData() != null) {
                                view.onOtherProductSuccess(response.body().getData().getData());
        ...
        Api.getService(Tags.base_url)
                ...
                .enqueue(new Callback<ProductDataModel>() {
                    ...
                    public void onResponse(Call<ProductDataModel> call, Response<ProductDataModel> response) {
                        ...
                        if (response.isSuccessful()) {
                            if (response.body() != null && response.body().getData() != null) {
                                view.onOfferSuccess(response.body().getData().getData());
